...
<div class="card">
    <div class="card-header">
        <strong>Thêm Danh Mục</strong> Sản Phẩm
    </div>
    <div class="card-body card-block">
        ...
        <form action="{{URL::to ('/save-category-product') }}" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-9"><input type="text" id="text-input" name="category_product_name" placeholder="Tên danh mục sản phẩm" class="form-control"></div>
            </div>
            <div class="row form-group">
                <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Mô tả Danh Mục Sản Phẩm</label></div>
                <div class="col-12 col-md-9"><textarea style="resize: none" name="category_product_desc" id="ckeditor" rows="5" placeholder="Mô tả Sản Phẩm" class="form-control"></textarea></div>
            </div>
            <div class="row form-group">
