...
<head>
    ...
    <title>Admin ChuonChuon</title>
    <meta name="description" content="Admin ChuonChuon">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="apple-touch-icon" href="{{ asset('public/backend/img/logolaptop.jpg') }}">
    <link rel="shortcut icon" href="{{ asset('public/backend/img/logolaptop.jpg') }}">
...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="{{ URL::to('/dashboard') }}"><i class="menu-icon fa fa-laptop"></i>Trang Quản Lý </a>
                    </li>
                    <li class="menu-title">UI elements</li><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-folder"></i>Danh Mục Sản Phẩm</a>
                        <ul class="sub-menu children dropdown-menu">                            
                            <li><i class="fa fa-plus-square"></i><a href="{{URL::to ('/add-category-product') }}">Thêm danh mục sản phẩm</a></li>
                            <li><i class="fa fa-list-alt"></i><a href="{{ URL::to('/list-category-product') }}">List danh mục sản phẩm</a></li>
                        </ul>
                    </li>
                    
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-folder"></i>Thương Hiệu Sản Phẩm</a>
                        <ul class="sub-menu children dropdown-menu">                            
                            <li><i class="fa fa-plus-square"></i><a href="{{ URL::to ('/add-brand-product') }}">Thêm thương hiệu sản phẩm</a></li>
                            <li><i class="fa fa-list-alt"></i><a href="{{ URL::to('/list-brand-product') }}">List thương hiệu sản phẩm</a></li>
                        </ul>
                    </li>

                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-folder"></i>Sản Phẩm</a>
                        <ul class="sub-menu children dropdown-menu">                            
                            <li><i class="fa fa-plus-square"></i><a href="{{ URL::to ('/add-product') }}">Thêm sản phẩm</a></li>
                            <li><i class="fa fa-list-alt"></i><a href="{{ URL::to('/list-product') }}">List sản phẩm</a></li>
                        </ul>
                    </li>

                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-folder"></i>Quản lý đơn hàng</a>
                        <ul class="sub-menu children dropdown-menu">                            
                            <li><i class="fa fa-plus-square"></i><a href="{{ URL::to ('/manager-order') }}">Đơn Hàng</a></li>
                        </ul>
                    </li>

                    {{-- <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-folder"></i>Mã Giảm Giá</a>
                        <ul class="sub-menu children dropdown-menu">                            
                            <li><i class="fa fa-plus-square"></i><a href="{{ URL::to ('/insert-coupon') }}">Thêm mã giảm giá</a></li>
                            <li><i class="fa fa-list-alt"></i><a href="{{ URL::to('/list-coupon') }}">List sản phẩm</a></li>
                        </ul>
                    </li> --}}
                </ul>
            </div><!-- /.navbar-collapse -->
    ...
    <div id="right-panel" class="right-panel">
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{ URL::to('/dashboard') }}"><img src="{{ asset('public/backend/img/logo.png') }}" alt="Logo"></a>
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img class="user-avatar rounded-circle" src="{{ asset('public/backend/img/logolaptop.jpg') }}" alt="User Avatar">
                        </a>
        ...
        <footer class="site-footer">
            <div class="footer-inner bg-white">
                <div class="row">
                    <div class="col-sm-6">
                        Copyright &copy; 2020 ChuonChuon
                    </div>
                    <div class="col-sm-6 text-right">
                        Designed by <a href="">ChuonChuon</a>
                    </div>
                </div>
            </div>
        </footer>
    ...
    <script src="{{ asset('public/backend/js/init/weather-init.js') }}"></script>
    ...
    <script src="{{ asset('public/backend/js/init/fullcalendar-init.js') }}"></script>
    {{-- ckeditor --}}
