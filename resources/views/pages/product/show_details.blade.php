					...
					<div class="product product-details clearfix">
						...
						<div class="col-md-6">
							<div class="product-body">
								...
								<p><strong>Mã Sản Phẩm:</strong> {{ $details->product_id }}</p>
								...
								<p><strong>Mô tả sản phẩm:</strong> {{ $details->product_desc }}</p>
								...
								<div class="product-btns">
									...
									<button type="submit" class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> Thêm Giỏ Hàng</button>
								</div>
								</form>
							</div>
						</div>
				...
				@foreach ($relate as $lienquan)
					<div class="col-md-3 col-sm-6 col-xs-6">
						<div class="product product-single">
							...
							<div class="product-body">
								<h3 class="product-price">{{ number_format($lienquan->product_price) }}</h3>
								<div class="product-rating">
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
									<i class="fa fa-star"></i>
								...
								<h2 class="product-name"><a href="#">{{ $lienquan->product_name }}</a></h2>
								<div class="product-btns">
									<a class="primary-btn add-to-cart" href="{{ URL::to('/chi-tiet-san-pham/'.$lienquan->product_id) }}"><i class="fa fa-shopping-cart"></i> Thêm Giỏ Hàng</a>
								</div>
							</div>
						</div>
					</div>
