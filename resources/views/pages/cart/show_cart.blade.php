					...
					<div class="col-md-12">
						<div class="order-summary clearfix">
							...
							@foreach ($content as $value_con)
								<tbody>
										<tr>
											...
											<td class="price text-center"><del class="font-weak"><small></small></del>{{ number_format($value_con->price) }} VNĐ</td>
											<form action="{{ URL::to('/update-cart-quantity') }}" method="POST">
												{{ csrf_field() }}
												<td class="qty text-center"><input class="input" type="number" name="cart_quantity" min="0" value="{{ $value_con->qty }}">
											...
											<td class="text-right"><a href="{{ URL::to('/delete-to-cart/'.$value_con->rowId) }}" class="main-btn icon-btn"><i class="fa fa-close"></i></a></td>
										</tr>
							...
							<div class="pull-right">
								...
								?>
									<a href="{{ URL::to('/login-checkout') }}" class="btn primary-btn">Thanh Toán</a>
								<?php
									}
								?>
							</div>
