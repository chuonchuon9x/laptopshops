						...
						<div class="billing-details">
							...
							<form action="{{ URL::to('/login-customer') }}" method="POST">
								...
								<div class="form-group">
									<input class="input" type="email" name="email_account" placeholder="Nhập Tài Khoản ...">
								</div>
								<div class="form-group">
									<input class="input" type="password" name="password_account" placeholder="Nhập Mật Khẩu ...">
								</div>
								<input type="submit" class="btn primary-btn" value="Đăng Nhập"/>
								<a class="btn primary-btn" href="{{ URL::to('/registration-checkout') }}">Đăng Ký</a>
							</form>
						</div>
					</div>
					<div class="col-md-3"></div>
