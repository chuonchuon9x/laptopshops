						...
						<div class="billing-details">
							...
							<form action="{{ URL::to('/add-customer') }}" method="POST">
								...
								<div class="form-group">
									<input class="input" type="text" name="customer_name" placeholder="Tên">
								</div>
								<div class="form-group">
									<input class="input" type="email" name="customer_email" placeholder="Email">
								</div>
								<div class="form-group">
									<input class="input" type="password" name="customer_password" placeholder="Nhập Mật Khẩu">
								</div>
								<div class="form-group">
									<input class="input" type="tel" name="customer_phone" placeholder="Điện Thoại">
								</div>
								<input type="submit" class="btn primary-btn" value="Đăng Ký"/>
							</form>
						</div>
                    </div>
                    <div class="col-md-3"></div>
